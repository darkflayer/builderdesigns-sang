...
const eventDetails = {
  1: {
    ...
    featured: true,
    description:
      "Join us for the most anticipated technology event of the year! Connect with industry leaders, discover cutting-edge innovations, and explore the future of technology. This summit brings together entrepreneurs, developers, investors, and visionaries from around the globe.",
    highlights: [
    ...
    subEvents: [
      {
        ...
        description:
          "Deep dive into AI and ML technologies with hands-on exercises",
      ...
      },
      {
        ...
        description:
          "Expert panel discussion on blockchain technology trends and future opportunities",
  ...
  2: {
    ...
    featured: false,
    description:
      "Master the latest digital marketing strategies and tactics in this intensive workshop. Learn from industry experts and get hands-on experience with the latest tools and platforms.",
    highlights: [
  ...
  3: {
    ...
    featured: false,
    description:
      "Experience an unforgettable evening of jazz music featuring renowned artists and emerging talents. Enjoy classic cocktails and sophisticated atmosphere.",
    highlights: [
  ...
  4: {
    ...
    featured: true,
    description:
      "Connect with fellow entrepreneurs, investors, and startup enthusiasts in Austin's thriving tech scene. This exclusive networking event brings together the most promising startups and influential investors.",
    highlights: [
    ...
    subEvents: [
      {
        ...
        description:
          "Present your startup to potential investors in a structured format",
  ...
  5: {
    ...
    featured: false,
    description:
      "Dive deep into the latest advances in artificial intelligence and machine learning. This conference features cutting-edge research, practical applications, and networking opportunities with AI experts.",
    highlights: [
  ...
  6: {
    ...
    featured: false,
    description:
      "Learn advanced photography techniques from award-winning photographers. This hands-on masterclass covers portrait, landscape, and street photography with practical shooting sessions.",
    highlights: [
  ...
  7: {
    ...
    featured: false,
    description:
      "Experience the excitement of championship basketball at its finest. Watch the season's best teams compete for the ultimate prize in this thrilling finale.",
    highlights: [
    ...
    organizer: {
      ...
      avatar:
        "https://images.unsplash.com/photo-1574623452334-1e0ac2b3ccb4?w=100&h=100&fit=crop",
  ...
  8: {
    ...
    featured: false,
    description:
      "Celebrate the finest in food and wine with local chefs, wineries, and culinary experts. Taste exceptional dishes, discover new wines, and enjoy live cooking demonstrations.",
    highlights: [
  ...
  9: {
    ...
    featured: false,
    description:
      "Experience the beauty of classical music performed by world-renowned musicians in the historic Symphony Hall. An evening of timeless compositions and exceptional artistry.",
    highlights: [
  ...
  10: {
    ...
    featured: false,
    description:
      "Explore cutting-edge contemporary art from emerging and established artists. This curated exhibition showcases innovative works across various mediums and artistic expressions.",
    highlights: [
            ...
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between space-y-3 lg:space-y-0">
                ...
                <div className="flex flex-col lg:items-end space-y-2 lg:space-y-2">
                  <span
                    className={`inline-flex self-start lg:self-end backdrop-blur-sm px-3 py-1 lg:px-4 lg:py-2 rounded-lg lg:rounded-xl text-sm lg:text-lg font-bold ${
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
                  ...
                  <div className="space-y-4">
                    {event.subEvents.map((subEvent, index) => (
                      <div
                        key={subEvent.id}
                        className="border border-gray-200 dark:border-gray-600 rounded-xl p-4 hover:border-blue-300 dark:hover:border-blue-500 transition-colors"
                      >
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500 dark:text-gray-500">
                              ...
                              <div className="flex items-center space-x-1">
                                ...
                                <span>
                                  {subEvent.currentAttendees}/
                                  {subEvent.maxAttendees} attendees
                                </span>
                              </div>
                              <div className="flex items-center space-x-1">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
                ...
                <div className="space-y-4">
                  {event.schedule.map((item, index) => (
                    <div
                      key={index}
                      className="flex items-start space-x-4 p-3 bg-gray-50 dark:bg-gray-700 rounded-xl"
                    >
            ...
            <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Registered on{" "}
                        {new Date(
                          userRegistration.registrationDate,
                        ).toLocaleDateString()}
                        {userRegistration.approvalDate &&
                          ` • Confirmed on ${new Date(userRegistration.approvalDate).toLocaleDateString()}`}
                      </p>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg sticky top-8">
                <div className="text-center mb-6">
                  <div
                    className={`text-2xl font-bold mb-2 px-4 py-2 rounded-xl ${
                      event.registrationType === "open"
