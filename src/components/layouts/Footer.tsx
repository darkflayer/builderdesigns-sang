...
export default function Footer() {
  ...
  const socialLinks = [
    { name: "Twitter", icon: Twitter, href: "https://twitter.com/sang" },
    { name: "Facebook", icon: Facebook, href: "https://facebook.com/sang" },
    {
      name: "Instagram",
      icon: Instagram,
      href: "https://instagram.com/sang",
    },
    {
      name: "LinkedIn",
      icon: Linkedin,
      href: "https://linkedin.com/company/sang",
    },
    { name: "GitHub", icon: Github, href: "https://github.com/sang" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
            <span>© {currentYear} Sang. Made with</span>
