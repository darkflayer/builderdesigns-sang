...
import { getUserOrganizations, getUserInvitations, getPendingRoleRequests, getOrganizationEvents, isAdmin, getUserRole, type Organization, type RoleRequest, type EventManagement } from "@/data/mockOrganizations";
    ...
    <div className="space-y-6">
      ...
      {userInvitations.length > 0 && (
        <div className="bg-yellow-50 dark:bg-yellow-900/20 rounded-xl p-4 border border-yellow-200 dark:border-yellow-800">
          <h3 className="font-semibold text-yellow-800 dark:text-yellow-400 mb-3">Pending Invitations</h3>
          <div className="space-y-3">
              ...
              <div key={invitation._id} className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-yellow-700 dark:text-yellow-500">
                    Role: {invitation.requestedRole} • From: {invitation.inviterName}
                  </p>
                </div>
                <div className="flex space-x-2">
          ...
          <div className="border-t border-gray-200 dark:border-slate-700 pt-4">
            ...
            <div className="flex flex-wrap gap-2">
              {event.team.map((member, index) => (
                <span key={index} className="bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-400 px-2 py-1 rounded text-xs">
          ...
          <div className="max-w-4xl mx-auto px-4">
            <div className="flex space-x-8">
              {[
                ...
                { id: 'requests', label: 'Requests', icon: ClockIcon, badge: pendingRequests.length }
              ].map((tab) => (
                <button
                  key={tab.id}
